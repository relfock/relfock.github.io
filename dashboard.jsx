...
// Norwegian analysehistorikk.json: array of { analyse, enhet, analysesvar: [ { dato, svar, enhet } ] }
// Dato format DD.MM.YYYY → we output YYYY-MM-DD. Svar can be "13,2", "<0,1", ">146,0", "Utført".
const NORWEGIAN_ANALYSE_TO_KEY = {
...
function parseNorwegianSvarToNumber(svar, enhet) {
...
function convertNorwegianValueToTarget(canonicalKey, num, enhet) {
...
function parseNorwegianAnalysehistorikk(jsonArray) {
